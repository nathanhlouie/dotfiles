...
#+begin_quote
WIP, NANO looks really good and I want to make this look just as good. Also Emacs 30 should be coming out soon on emacs-mac (hopefully). And, I want to redo the literate config into separate files for easier organization.
#+end_quote
